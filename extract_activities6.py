    ...
    for script in soup.find_all('script'):
        if script.string and 'latitude' in script.string:
            try:
                ...
                print(f"Error parsing script content for {url}: {e}")
                continue
...
with open('activities6.json', 'w', encoding='utf-8') as f:
    json.dump(activities, f, ensure_ascii=False, indent=4)

print("Data has been extracted and saved to 'activities6.json'")
